...
- **Performance-friendly** background loading
- Requires **no high-end hardware** to run efficiently
- Works seamlessly on **Survival & Hardcore** without enabling cheats
- **User-Friendly GUI** designed for effortless configuration
...
**Render Distance+ solves this problem entirely:**
* **100% Automated Background Loading:** The datapack dynamically handles all the heavy Chunky commands in the background while the player explores the world.
...
2. When creating a new world in Minecraft, click on the **Datapacks** tab.
3. Drag and drop the downloaded `.zip` file into the menu, move it to the selected column, and create your world.

<details>
<summary>How to install this datapack on an existing world?</summary>

1. Select your world in the Minecraft singleplayer menu and click on **Edit**.
2. Click on **Open World Folder** and navigate to the `datapacks` folder.
3. Copy the Render Distance+ `.zip` file directly into this folder.
4. Join your world and type `/reload` to initialize the system.
...
If the installation was successful, a custom text-based configuration GUI will immediately pop up in your chat, allowing you to begin your automated chunk-loading setup.


<details>
<summary>Requirements (Mods)</summary>

- Chunky (Required for background generation)
- Voxy (Required for high render distances)
